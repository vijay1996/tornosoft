...
var returnUser = function (userInfo) { return __awaiter(void 0, void 0, void 0, function () {
    var returnData, error, Users;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                returnData = [];
                error = '';
                Users = mongoose.model('user', models_1.userSchema);
